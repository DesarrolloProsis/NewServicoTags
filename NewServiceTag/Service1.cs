        ...
        public void MetodoInicial()
        {
            ...
            else
            {
                Query = @"SELECT CONTENU_ISO, VOIE, ID_GARE, TAB_ID_CLASSE, TO_CHAR(DATE_TRANSACTION, 'dd/mm/yyyy hh24:mi:ss')DATE_TRANSACTION, PRIX_TOTAL, EVENT_NUMBER, TAG_TRX_NB, INDICE_SUITE
                        ...
                        AND TO_CHAR(DATE_TRANSACTION, 'YYYY/MM/DD HH24:MI:SS' ) > '2021/01/13 00:00:00' and DATE_TRANSACTION < TO_DATE('2021/01/14 00:00:00','YYYY/MM/DD HH24:MI:SS')  AND SUBSTR(TO_CHAR(CONTENU_ISO),0,3) = '501' AND TAB_ID_CLASSE >= 1";
            }
